...
```html
<i-cell-group>
  <i-field v-model="value" label="账号" clearable></i-field>
</i-cell-group>
```
...
```html
<i-cell-group>
  <i-field v-model="value" label="Password" type="password" clearable></i-field>
...
```html
<i-cell-group>
  <i-field v-model="value" label="短信验证码" placeholder="请输入验证码" clearable>
